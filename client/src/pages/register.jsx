    ...
    const handlenameChange = (e) => {
      ...
      const handleRegister = async () => 
      {
        try { 
            ...
            const data = { name , password , rollNo , email };
            console.log(data) ;
  ...
  return (
    ...
    <div class="min-h-screen bg-purple-400 flex justify-center items-center">
        ...
        <div class="py-12 px-12 bg-white rounded-2xl shadow-xl z-20">
            ...
            <div class="space-y-4">
                <input type="text" placeholder="20ume003@lnmiit.ac.in" class="block text-sm py-3 px-4 rounded-lg w-full border outline-none" onChange={handlemailChange}/>
                <input type="text" placeholder="Aditya" class="block text-sm py-3 px-4 rounded-lg w-full border outline-none" onChange={handlenameChange}/>
                ...
                <div class="text-center mt-6">
                    <button class="py-3 w-64 text-xl text-white bg-purple-400 rounded-2xl hover:bg-purple-700" onClick ={handleRegister}>Create Account</button>
